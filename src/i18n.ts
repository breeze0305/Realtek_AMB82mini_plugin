...
export const translations = {
  zh_TW: {
    ...
    files: "檔案取得",
    installerFiles: "安裝檔",
    installerFilesSummary: "驅動程式、Arduino IDE、CLI PATH 設定與 VLC",
    installerFilesDetail: "可另存安裝檔，或由箭頭選單自動安裝；Arduino IDE 自動安裝完成後會將 CLI 加入 PATH",
    arduinoCliPathTitle: "將 Arduino CLI 加入 PATH",
    arduinoCliNotInstalled: "尚未安裝",
    arduinoCliNotInstalledDetail: "請先安裝 Arduino IDE 2.x，安裝完成後即可將內附的 CLI 加入使用者 PATH。",
    arduinoCliNotOnPathDetail: "已安裝 Arduino CLI，尚未加入 PATH；加入後可在終端機直接使用 arduino-cli。",
    arduinoCliOnPathDetail: "Arduino CLI 已加入 PATH，可在新開啟的 CMD／PowerShell 中使用 arduino-cli。",
    arduinoCliAddPath: "加入 PATH",
    arduinoCliOnPath: "已加入 PATH",
    arduinoCliChecking: "檢查中…",
    arduinoCliStatusUnavailableLabel: "無法確認",
    arduinoCliStatusUnavailable: "暫時無法確認 Arduino CLI 狀態，請重新進入此頁面再試。",
    arduinoCliPathSuccess: "Arduino CLI 已加入 PATH，請重新開啟 CMD／PowerShell 後使用 arduino-cli。",
    arduinoCliAutomaticPathFailed:
      "Arduino IDE 已安裝，但 CLI 加入 PATH 失敗；請使用「將 Arduino CLI 加入 PATH」卡片重試。",
    arduinoCliConfiguring: "設定 PATH 中…",
    installerInstalling: "安裝中…",
    installerWaitingDetail: "正在等待安裝完成，請勿關閉本工具；若出現 Windows 權限提示，請依提示操作。",
    installerComplete: "{app} 安裝完成。",
    installerRebootRequired: "安裝程式要求重新啟動 Windows，請儲存工作後自行重新啟動。",
  ...
  en_US: {
    ...
    installerFilesSummary: "Drivers, Arduino IDE, CLI PATH setup, and VLC",
    installerFilesDetail:
      "Save an installer or use the arrow menu to auto install; Arduino IDE auto install also adds its CLI to PATH",
    arduinoCliPathTitle: "Add Arduino CLI to PATH",
    arduinoCliNotInstalled: "Not installed",
    arduinoCliNotInstalledDetail: "Install Arduino IDE 2.x first, then add its bundled CLI to your user PATH.",
    arduinoCliNotOnPathDetail:
      "Arduino CLI is installed but not on PATH. Add it to run arduino-cli directly in a terminal.",
    arduinoCliOnPathDetail: "Arduino CLI is on PATH. Run arduino-cli in a newly opened CMD or PowerShell window.",
    arduinoCliAddPath: "Add to PATH",
    arduinoCliOnPath: "On PATH",
    arduinoCliChecking: "Checking…",
    arduinoCliStatusUnavailableLabel: "Status unavailable",
    arduinoCliStatusUnavailable: "Unable to check Arduino CLI status. Reopen this page to try again.",
    arduinoCliPathSuccess: "Arduino CLI is on PATH. Reopen CMD or PowerShell before running arduino-cli.",
    arduinoCliAutomaticPathFailed:
      "Arduino IDE was installed, but adding its CLI to PATH failed. Retry with the Add Arduino CLI to PATH card.",
    arduinoCliConfiguring: "Setting up PATH…",
    installerInstalling: "Installing…",
    installerWaitingDetail:
      "Waiting for installation to finish. Keep this tool open and respond to any Windows permission prompt.",
    installerComplete: "{app} installation completed.",
    installerRebootRequired: "The installer requires a Windows restart. Save your work, then restart when ready.",
  ...
  ja_JP: {
    ...
    installerFilesSummary: "ドライバー、Arduino IDE、CLI の PATH 設定、VLC",
    installerFilesDetail:
      "インストーラーの保存、または矢印メニューから自動インストールができます。Arduino IDE の自動インストール後は CLI も PATH に追加されます",
    arduinoCliPathTitle: "Arduino CLI を PATH に追加",
    arduinoCliNotInstalled: "未インストール",
    arduinoCliNotInstalledDetail:
      "まず Arduino IDE 2.x をインストールしてください。その後、付属の CLI をユーザー PATH に追加できます。",
    arduinoCliNotOnPathDetail:
      "Arduino CLI はインストール済みですが、PATH に未追加です。追加するとターミナルで arduino-cli を直接実行できます。",
    arduinoCliOnPathDetail:
      "Arduino CLI は PATH に追加済みです。新しく開いた CMD／PowerShell で arduino-cli を使用できます。",
    arduinoCliAddPath: "PATH に追加",
    arduinoCliOnPath: "追加済み",
    arduinoCliChecking: "確認中…",
    arduinoCliStatusUnavailableLabel: "確認できません",
    arduinoCliStatusUnavailable: "Arduino CLI の状態を確認できません。このページを開き直して再試行してください。",
    arduinoCliPathSuccess:
      "Arduino CLI を PATH に追加しました。CMD／PowerShell を開き直してから arduino-cli を使用してください。",
    arduinoCliAutomaticPathFailed:
      "Arduino IDE のインストールは完了しましたが、CLI の PATH 追加に失敗しました。「Arduino CLI を PATH に追加」カードから再試行してください。",
    arduinoCliConfiguring: "PATH を設定中…",
    installerInstalling: "インストール中…",
    installerWaitingDetail:
      "インストールの完了を待っています。このツールを閉じずに、Windows の権限確認が表示された場合は指示に従ってください。",
    installerComplete: "{app} のインストールが完了しました。",
    installerRebootRequired:
      "インストーラーから Windows の再起動が要求されました。作業を保存してから再起動してください。",
